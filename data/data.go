...
"Programming today is a race between software engineers striving to build bigger and better idiot-proof programs, and the universe trying to produce bigger and better idiots. So far, the universe is winning.|Rick Cook",
"The secret of living a life of excellence is merely a matter of thinking thoughts of excellence. Really, it’s a matter of programming our minds with the kind of information that will set us free.|Charles R. Swindoll 95. There are only two kinds of programming languages: those people always bitch about and those nobody uses.|Bjarne Stroustrup",
"One of my most productive days was throwing away 1000 lines of code.|Ken Thompson</strong> </em>",
...
"Proprietary programming like news can be a great weapon.|Alan Gerry",
...
"What’s in your hands I think and hope is intelligence: the ability to see the machine as more than when you were ﬁrst led up to it that you can make it more.|Alan J. Perlis",
...
"Programming isn’t about what you know; i’s about what you can figure out.|Chris Pine",
...
"A programmer is a device for turning caffeine into code.|Unknown",
