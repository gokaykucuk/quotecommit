...
func main() {
	...
	color.New(color.Bold, color.Italic, color.BgCyan).Print("      " + splitted_message[1]+ "     ")
	...
	color.New(color.BlinkSlow,color.FgRed).Println("\n!!! Please do this as rarely as possible !!!")
}
